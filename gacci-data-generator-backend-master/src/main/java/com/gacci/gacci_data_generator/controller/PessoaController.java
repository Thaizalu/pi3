...
public class PessoaController {
    ...
    @PostMapping("/save")
    public ResponseEntity<Pessoa> salvarPessoa(@RequestPart PessoaDTO pessoa, @RequestParam("file") MultipartFile file) throws IOException {
    ...
    public ResponseEntity<Pessoa> getDetails(@PathVariable Long id) {
        Pessoa pessoa = service.inativar(id);
        return ResponseEntity.ok(pessoa);
    }


    @GetMapping("/download/{id}")
    public ResponseEntity<Map<String, Object>> downloadAnexo(@PathVariable Long id) throws IOException {
